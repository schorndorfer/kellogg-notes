...
\begin{column}{0.5\textwidth}
\begin{center}
	\fbox{\includegraphics[scale=0.1]{figures/information.jpg}}
\end{center}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
  \fbox{\includegraphics[scale=0.15]{figures/breast-cancer-note-screenshot.png}}
  \fbox{\includegraphics[scale=0.21]{figures/breast-cancer-note-screenshot-hex.png}}
\end{center}
\end{column}
\end{columns}
\end{frame}
